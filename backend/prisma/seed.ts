...
const productData: IProduct[] = [
  {
    ...
    createdBy: 1,
    avgRating: 3,
    pic: `http://localhost:${config.port}/static/products/ddc-standard-milk.jpg`,
    stock: 5,
  },
  {
    ...
    categoryId: 1,
    createdBy: 1,
    pic: `http://localhost:${config.port}/static/products/ddc-cow-milk.jpg`,
    stock: 5,
  },
  {
    ...
    sellingPrice: 50,
    categoryId: 2,
    pic: `http://localhost:${config.port}/static/products/nanglo-bread.jpg`,
    createdBy: 1,
    stock: 2,
  },
  {
    ...
    costPrice: 40,
    sellingPrice: 50,
    pic: `http://localhost:${config.port}/static/products/lays-blue.jpg`,
    categoryId: 3,
    createdBy: 1,
    stock: 2,
  },
  {
    ...
    costPrice: 40,
    sellingPrice: 50,
    pic: `http://localhost:${config.port}/static/products/lays-green.jpg`,
    categoryId: 3,
    createdBy: 1,
    stock: 2,
  },
